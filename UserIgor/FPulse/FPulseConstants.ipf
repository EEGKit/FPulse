...
//strconstant	ksCOM_			= "com:"			// the subfolder for the  common  variables needed both in  Acq  and in   Eval . Do not change as action proc names (and globals in panels) depend on it.
...
strconstant	ksEVAL_			= "eva:"			// the subfolder for the  'evaluation'  variables. Do not change as action proc names rely on it. At most 3 letters or else control action proc names will be too long)
strconstant	ksF_IO_			= "io:"

//strconstant	ksCOM			= "com"			// the subfolder for the  common  variables needed both in  Acq  and in   Eval . Do not change as action proc names (and globals in panels) depend on it.
...
strconstant	ksEVAL			= "eva"			// the subfolder for the  'evaluation'  variables. Do not change as action proc names rely on it. At most 3 letters or else control action proc names will be too long)
strconstant	ksF_IO			= "io"

// 060127
strconstant	ksKEEP 			= "pul"			// DO NOT CAHANGE unless VERY MANY variables (and control names .._acq_pul_.. ) are also changed.  Valid for   Acq   and   Eva  .  Must be a  folder which is NOT cleared when a new script is loaded.
...
strconstant	ksEVALCFG_DIR		= "C:Epc:Data:EvalCfg:"
strconstant	ksEVALMOVIE_DIR		= "C:Epc:Data:Movie:"
...
strconstant	ksEVAL_WNM		= "Eval"		// 041215 
