...
static Function		InitPanelTest( sFolder, sPnOptions )
...
//	n += 1;	tPn[ n ] =	"PN_BUTTON;	buDebugPrintOptions			;Print options (Debug)"
	n += 1;	tPn[ n ] =	"PN_BUTTON;	buDispTimeForReadScript_	;Measure time needed for 'Apply'"
	n += 1;	tPn[ n ] =	"PN_BUTTON;	buDispTimeForReadCfs_		;Measure time needed for 'ReadCfs'"
	...
	n += 1;	tPn[ n ] =	"PN_BUTTON;	buShowSweepTimes_		;Show sweep times"
	n += 1;	tPn[ n ] =	"PN_BUTTON;	buStopBackgroundTask_		;Stop background task"
	n += 1;	tPn[ n ] =	"PN_SEPAR"
...
Function		buDispTimeForReadScript_( ctrlName ) : ButtonControl
	string 	ctrlName
...
Function		buDispTimeForReadCfs_( ctrlName ) : ButtonControl
	string 	ctrlName
...
Function		buShowSweepTimes_( ctrlName ) : ButtonControl
	string 		ctrlName
...
Function		buStopBackgroundTask_( ctrlName ) : ButtonControl
	string 	ctrlName	
...
//	string  	sFolder 
//	wave	wG
//	nvar		gnReps		= root:uf:aco:co:gnReps			// these..
//	nvar 		gChnkPerRep	= root:uf:aco:co:gChnkPerRep		// are
//	nvar		gPntPerChnk	= root:uf:aco:co:gPntPerChnk		// all
//	nvar		gSmpArOfsDA	= root:uf:aco:co:gSmpArOfsDA		// set
//	nvar 		gSmpArOfsAD	= root:uf:aco:co:gSmpArOfsAD		// by
//	nvar		gnOfsDO		= root:uf:aco:co:gnOfsDO			// SetPoints ()
//	string		bf
...
//			gsScriptPath	= LoadScript_( ksACOld , sScript, rCode, kbNEW_ACQ_DISP )								// pass an empty path to invoke a FileOpenDialog
...
//Function		root_uf_aco_co_gCOLBUTCOL( s )
...
static Function		InitPanelMC700( sFolder, sPnOptions )
	string  	sFolder, sPnOptions
	string		sPanelWvNm = 	  "root:uf:" + sFolder + sPnOptions
