...
constant		kIGOR_POINTS72		= 72	// needed to convert from screen pixels to points
constant		kIGOR_XMIN_WNDLOC	= 2	// needed to convert from screen pixels to points
constant		kIGOR_XMISSINGPIXEL	= 5	// needed to convert from screen pixels to points 
constant		kIGOR_YMIN_WNDLOC	= 37	// needed to convert from screen pixels to points (=GetIgorAppPoints( ->YMinPoints ) )
...
Function		GetIgorAppPoints( rxMinPoints, rxMaxPoints, ryMinPoints, ryMaxPoints )
...
// Convert to IGOR points giving the maximum IGOR window possible (coordinates in points) 
	...
	variable	xMaxPixel	= GetIgorAppPixelX() 
	variable	yMaxPixel	= GetIgorAppPixelY() 
...
Function		GetAutoWindowCorners( row, nRows, col, nCols, rnLeft, rnTop, rnRight, rnBot, xL100, xR100 )
	...
	variable	XPTS = GetIgorAppPixelX() *  0.6			// independent of screen resolution
	variable 	YPTS = GetIgorAppPixelY() *  0.6	
