...
// UFP_CedError.H  AND  FPULSE.IPF : Error handling: where and how are error messages displayed
...
// make the corresponding text entry in UFP_CedWinCustom.RC 
// CED error codes from -500..-611 (see  Use1401.h  or  prog int lib dec 1999, p34)
