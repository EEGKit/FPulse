...
{	
   ...
   LoadXOPSegs();										// für Funktionen
	...
	//sprintf( sMsg, "UFP_MC700Tg.XOP (+MCTG)\tWITHOUT XOP WINDOW (#ifdef MCTG_IGORMAINFRM) IgorClientHWND:%08X>%08X (%s) \r", IgorClientHWND(), gTheWindow, CALLING_METHOD ? "direct" : "message" );	XOPNotice( sMsg );
