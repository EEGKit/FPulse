...
#include "\Programme\wavemetrics\IgorXOPs\XOPSupport\XOPStandardHeaders.h" //..ANSI headers IgorXOP.h XOP.h XOPSupport.h
...
/*	
   ...
   // ..are renumbered into the range 100..211   (see UFmdt_CfsWinCustom.RC)
...
//	sprintf( sMsg, "************************\r***** D E B U G *****\r************************\r" );
	sprintf( sMsg, "Loaded UFmdt_Cfs.xop (debug) \r" );
	XOPNotice( sMsg );
#else
	sprintf( sMsg, "Loaded UFmdt_Cfs.xop\r" );
	XOPNotice( sMsg );
#endif
