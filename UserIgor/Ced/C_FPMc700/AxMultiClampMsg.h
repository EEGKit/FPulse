...
// UF  Changed to make compile  040922	: removed  '  extern "C" {  '  and  ' } '
...
// UF  Changed to make compile  040922 : removed :
// extern "C" {	
...
// API version number.
#define MCCMSG_APIVERSION       1,0,0,5
#define MCCMSG_APIVERSION_STR  "1.0.0.5"
