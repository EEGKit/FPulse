...
strconstant	ksPN_MOVIE	= "movi"						// To gain full advantage of this string constant  ALL control names in this panel must be converted e.g. "root_uf_" + sFolder_ + " + ksPN_MOVIE + "_buStartMov0000" which  blows up the code quite a bit...
...
AdditionalMoviesVars( sWin )									// will construct additionally required variables and strings in the same folder as the panel variables. This in turn requires that  'MoviesPanel( .....kPANEL_INIT )' is called during initialisation.
...
//	n += 1;	tPn[ n ] =	"PM:	   1:	0:	9:	2:	°:	,:	1,°:		pmMovChan:	:				:			:			60:		fEvChanMovPops_():					~1:		:		Movie Channel:		"	// 	
	...
	n += 1;	tPn[ n ] =	"BU:    0:	3:	6:	0:	°:	,:	1,°:		buRewndMov:	Rewind:			:			fMovieRewind_):	:		:								:		:		Start Movie:		"	//  	
...
static Function		AdditionalMoviesVars( sWin )
