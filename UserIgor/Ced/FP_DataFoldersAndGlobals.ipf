...
Function		ConstructAndMakeItCurrentFolder( sFolderPath )
...
Function		KillDataFolderUnconditionally( sFolderPath )
	string  	sFolderPath
	if ( DataFolderExists( sFolderPath ) )
		ZapDataInFolderTree( sFolderPath )
		KillDataFolder   $sFolderPath
		if ( V_Flag )
			Alert( kERR_IMPORTANT, "Could not kill data folder '" + sFolderPath + "' .  Objects left:\r" )
...
Function 		ZapDataInFolderTree( sFolderPath )
...
Function		PossiblyKillDataFolder( sFolderPath )
	string 	sFolderPath
	if ( DatafolderExists( sFolderPath ) )
		KillDataFolder  $sFolderPath
	endif
...
// Function	OfferForEdit( sProcFileName )	
...
Function		GVarCE( sFolderVarNm, DefaultValue )
...
Function		SetGVar( sFolderVarNm, Value )
...
Function	/S	GStringCE( sFolderStringNm, sDefaultString )
...
Function	/S	GString( sFolderStringNm )
...
Function	/S	SetGString( sFolderStringNm, sString )
