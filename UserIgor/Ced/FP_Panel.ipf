...
// e.g.  execute from the command line   PnTESTAllTitlesOrHelptopics( 'root:uf:evo:', 'sde' )   or  PnTESTAllTitlesOrHelptopics( 'root:uf:aco:', 'sda' )   or    PnTESTAllTitlesOrHelptopics( "root:uf:" , "rec" )
	string  	sF, sWin	
	wave   /T	wPn		= $PanelWvNm( sF, sWin )
	variable	n, nCnt	= DimSize( wPn, 0 )
	variable	nLen
