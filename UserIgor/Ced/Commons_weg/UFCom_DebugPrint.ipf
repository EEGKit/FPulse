...
Function		PanelDebugPrint()
	...
	UFCom_Panel3Sub(   sWin, 	sPnTitle,	sFBase + sFSub,  0, 0, kPANEL_DRAW )	// Compute the location of panel controls and the panel dimensions. Draw the panel displaying and hiding needed/unneeded controls
End
