//
//   	_UF_AcqTest_4.ipf		( for Version 4nn)
// 
...
Menu "Test4"
	"Test functions V4...",		PnTest4_()				// 
End

//-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

static strconstant	ksPN_NAME		= "tst"			// Panel name   _and_  subfolder name  _and_  section keyword in INI file
static strconstant	ksPN_TITLE		= "Test V4"		// The  button base name (without prefix root:uf... and postfix 0000) in the main panel displaying and hiding THIS subpanel
static strconstant	ksPN_CTRLBASE	= "buPnTest"		// The  button base name (without prefix root:uf... and postfix 0000) in the main panel displaying and hiding THIS subpanel
...
// The  Button action procedure of the button in the main panel displaying and hiding THIS subpanel.  Unfortunately we can not wrap this in a function because of the specific Panel creation function name below (due to hook function)
	...
	if ( state )															// if we want to  _display_  the panel...
		if ( WinType( ksPN_NAME ) != UFCom_WT_PANEL )						// ...and only if the panel does not yet  exist ..
			PnTest4( UFCom_kPANEL_DRAW )						// *** specific ***...we must build the panel
		else
...
Function		PnTest4_()
	PnTest4( UFCom_kPANEL_DRAW )
End 

Function		PnTest4( nMode )
// Create the panel.  Unfortunately we can not wrap this in a function because of the specific hook function name
	...
	InitPanelTest4( sFBase + sFSub, ksPN_NAME )						// *** specific ***fills big text wave  'sPnOptions' (=wPn)  with all information about the controls necessary to build the panel
	UFCom_RestorePanel2Sub( ksACQ, ksFPUL, ksPN_NAME, ksPN_TITLE, sFBase, sFSub, ksPN_INISUB, ksPN_INIKEY, ksPN_CTRLBASE, nMode )
	SetWindow		$ksPN_NAME,  hook( $ksPN_NAME ) = fHookTest4			// *** specific ***
...
Function		InitPanelTest4( sF, sPnOptions )
	string  	sF, sPnOptions
	string		sPanelWvNm = sF + sPnOptions
	variable	n = -1, nItems = 50
	// printf "\t\tInitPanelTest4( '%s',  '%s' ) \r", sF, sPnOptions 
	...
	n += 1;	tPn[ n ] =	"BU:    1:	0:	1:	0:	°:		,:		1,°:			buTimRdScr:	Measure time needed for 'Apply':			:		fTimRdScr():	:		:			:			:		:	"
	n += 1;	tPn[ n ] =	"BU:    1:	0:	1:	0:	°:		,:		1,°:			buTimRdCfs:	Measure time needed for 'ReadCfs':		:		fTimRdCfs():	:		:			:			:		:	"
	n += 1;	tPn[ n ] =	"BU:    1:	0:	1:	0:	°:		,:		1,°:			buShowSwpT:	Show sweep times:					:		fShowSwpT():	:		:			:			:		:	"
	n += 1;	tPn[ n ] =	"BU:    1:	0:	1:	0:	°:		,:		1,°:			buKillFold:		Kill  folder  'Root_uf_acq':				:		fKillFolder():	:		:			:			:		:	"
	n += 1;	tPn[ n ] =	"BU:    1:	0:	1:	0:	°:		,:		1,°:			buKillAllTi:		Kill All Timers:						:		fKillAllTimers():	:		:			:			:		:	"
	n += 1;	tPn[ n ] =	"BU:    1:	0:	1:	0:	°:		,:		1,°:			buElimBlnk:	Switch 'Eliminate Blanks' Mode:			:		fElimBlank():	:		:			:			:		:	"
	n += 1;	tPn[ n ] =	"SEP:  1:	0:	1:	0:	°:		,:		1,°:			dum20:		:								:		:			:		:			:			:		:						" 

	n += 1;	tPn[ n ] =	"BU:    1:	0:	1:	0:	°:		,:		1,°:			buTest2:		Test2  Trace access for user:			:		fTest2():		:		:			:			:		:	"
	n += 1;	tPn[ n ] =	"BU:    1:	0:	1:	0:	°:		,:		1,°:			buTest3:		Test3   Waves in Folders:				:		fTest3():		:		:			:			:		:	"
	n += 1;	tPn[ n ] =	"BU:    1:	0:	1:	0:	°:		,:		1,°:			buTest4:		Test4   Igors numbers:				:		fTest4():		:		:			:			:		:	"
	n += 1;	tPn[ n ] =	"BU:    1:	0:	1:	0:	°:		,:		1,°:			buTest5:		Test5   AppendToGraph:				:		fTest5():		:		:			:			:		:	"
	n += 1;	tPn[ n ] =	"BU:    1:	0:	1:	0:	°:		,:		1,°:			buTest6:		Test6   DisplayHelpTopic:				:		fTest6():		:		:			:			:		:	"
// moved elsewhere
//	n += 1;	tPn[ n ] =	"BU:    1:	0:	1:	0:	°:		,:		1,°:			buTest7:		Test7   SetPoints Once:				:		fTest7():		:		:			:			:		:	"
//	n += 1;	tPn[ n ] =	"BU:    1:	0:	1:	0:	°:		,:		1,°:			buTest8:		Test8   SetPoints Cont:				:		fTest8():		:		:			:			:		:	"
//	n += 1;	tPn[ n ] =	"BU:    1:	0:	1:	0:	°:		,:		1,°:			buTest9:		Test9   SetPoints Cont + neighbours:		:		fTest9():		:		:			:			:		:	"
	n += 1;	tPn[ n ] =	"BU:    1:	0:	1:	0:	°:		,:		1,°:			buTest10:		Test10  Primes:						:		fTest10():		:		:			:			:		:	"
	n += 1;	tPn[ n ] =	"BU:    1:	0:	1:	0:	°:		,:		1,°:			buTest11:		Test11  ReplaceListItem:				:		fTest11():		:		:			:			:		:	"
	n += 1;	tPn[ n ] =	"BU:    1:	0:	1:	0:	°:		,:		1,°:			buTest12:		Test12  Heap scramble + TransferArea:	:		fTest12():		:		:			:			:		:	"
	n += 1;	tPn[ n ] =	"BU:    1:	0:	1:	0:	°:		,:		1,°:			buTest13:		Test13  Ced U14Ld:					:		fTest13():		:		:			:			:		:	"
	n += 1;	tPn[ n ] =	"BU:    1:	0:	1:	0:	°:		,:		1,°:			buTest14:		Test14  bCRASH_ON_REDIM - AutoLoadScripts::	fTest14():		:		:			:			:		:	"
	n += 1;	tPn[ n ] =	"BU:    1:	0:	1:	0:	°:		,:		1,°:			buTest15:		Test15  SetVariable + PopupMenu Format:	:		fTest15():		:		:			:			:		:	"
	n += 1;	tPn[ n ] =	"BU:    1:	0:	1:	0:	°:		,:		1,°:			buTest16:		Test16  Try-Catch-EndTry: foo_(0..6):		:		fTest16():		:		:			:			:		:	"
	n += 1;	tPn[ n ] =	"BU:    1:	0:	1:	0:	°:		,:		1,°:			buTest17:		Test17  Fonts:						:		fTest17():		:		:			:			:		:	"
	n += 1;	tPn[ n ] =	"BU:    1:	0:	1:	0:	°:		,:		1,°:			buTest18:		Test18 Setk ksFONT , UFCom_kFONTSIZE::		fTest18():		:		:			:			:		:	"
	n += 1;	tPn[ n ] =	"BU:    1:	0:	1:	0:	°:		,:		1,°:			buTest19:		Test19  Construct sin wave:			:		fTest19():		:		:			:			:		:	"
	n += 1;	tPn[ n ] =	"BU:    1:	0:	1:	0:	°:		,:		1,°:			buTest20:		Test20  Construct sine sweep for filter test:	:		fTest20():		:		:			:			:		:	"
	n += 1;	tPn[ n ] =	"BU:    1:	0:	1:	0:	°:		,:		1,°:			buTest21:		Test21  pd : pad/truncate:				:		fTest21():		:		:			:			:		:	"
	n += 1;	tPn[ n ] =	"BU:    1:	0:	1:	0:	°:		,:		1,°:			buTest22:		Test22  Subrange display:				:		fTest22():		:		:			:			:		:	"
	n += 1;	tPn[ n ] =	"BU:    1:	0:	1:	0:	°:		,:		1,°:			buTest23:		Test23  Check Memory:				:		fTest23():		:		:			:			:		:	"
	n += 1;	tPn[ n ] =	"BU:    1:	0:	1:	0:	°:		,:		1,°:			buTest24:		Test24  unused:						:		fTest24():		:		:			:			:		:	"

// 2008-02-28 off  because it crashes Igor
//	n += 1;	tPn[ n ] =	"PN_SEPAR"
...
//	n += 1;	tPn[ n ] =	"PN_BUTTON;	bu_DICOLTXT_Test_ ;COLTest + cc; 	| PN_DICOLTXT;  root:uf:com:gDICOLTXT ; wait0~acq1~trig2~run3;  ;  ;  35000,35000,65535 ~ 60000,0,65000 ~ 60000,60000,0 ~ 0,60000,0;    " //  No Oversize : no trailing  | 
//	//n += 1;	tPn[ n ] =	"PN_BUTTON;	bu_DICOLTXT_Test_ ;COLTest + cc;	| PN_DICOLTXT;  root:uf:com:gDICOLTXT ; wait0~acq1~trig2~run3;  ;1;  35000,35000,65535 ~ 60000,0,65000 ~ 60000,60000,0 ~ 0,60000,0;   | " //  'OverSize' is > 0 reqires trailing  | 
...
//	string 		ctrlName		
//	UFPE_DebugPrintOptions()
//End

Function		fTimRdScr( s )
	struct	WMButtonAction &s
...
Function		fShowSwpT( s ) 
	struct	WMButtonAction &s
	printf "ShowSweepTimes()  %s    \r",  s.ctrlName
...
print "todo buShowSweepTimes"
//	UFPE_ShowSwTimes( sFolder, wG, wFix )						//(//  UFPE_Stim
End


Function		fKillFolder( s )
	struct	WMButtonAction &s
	UFCom_KillDataFoldUnconditionly( "root:uf:acq" )
	printf "\r\tUFCom_KillDataFoldUnconditionly( 'root:uf:acq'  ) \r"
End


Function		fKillAllTimers( s )
	struct	WMButtonAction &s
	printf "\r\tKillAllTimers()\r"
	UFCom_KillAllTimers( ksACQ )
End


Function		fElimBlank( s )
//  Set the mode how NoStore-Periods are handled:
	struct	WMButtonAction &s
	string 	ctrlName	
	variable	nEBmode	= ELIMINATE_BLANKS()
	printf "\r\tSwitching 'Eliminate Blanks'  mode  from %2d  " , ELIMINATE_BLANKS()
	variable /G root:uf:acq:nEliminateBlanksMode	= mod( nEBmode + 1, 3 )
	printf "to %2d    [Note: requires reloading the script  to become effective] \r" , ELIMINATE_BLANKS()
End
...
Function		fTest2( s ) 
	...
	wave 	wG		= $"root:uf:" + sFolder + ":keep:wG"  					// This  'wG'  	is valid in FPulse ( Acquisition )
	wave 	wFix		= $"root:uf:" + sFolder + ":ar:wFix"  					// This  'wFix'  	is valid in FPulse ( Acquisition )
	ShowTraceAccess( sFolder )							//(//	UF_AcqDisp
End
...
Function		fTest3( s )
	...
	make  /O root:uf:acq:disp:wInRootDisp = cos( .1*x )
	make  /O root:uf:acq:disp:wInRootDisp2 = .5* cos( .1*x )
	wave	wInSubFolder2 = root:uf:acq:disp:wInRootDisp2

	display /K= 1 wInRoot
	UFCom_delay(1)
	AppendToGraph root:uf:acq:disp:wInRootDisp, wInSubFolder2	// Folder !
	UFCom_delay(1)
	...
	SetScale 	/P x, 0, 3, "frame" , 	wInRoot , root:uf:acq:disp:wInRootDisp, wInSubFolder2 	// FOLDER !
End
...
//
//
//Function		SetPointsTestOnce( sFolder, wG )		// 2003-0724
...
//
////	nCEDMemPts	=  8000000;	nPnts	= 560010;		nSmpInt	=  50;	nDA	= 1;	nAD	= 2;	nTG	= 2;	nSlices	=  1630	// 2003-0901
//
//	nCEDMemPts	=  8000000;	nPnts	= 1024*1024-29800;	nSmpInt	=  50;	nDA	= 1;	nAD	= 1;	nTG	= 1;	nSlices	=  1630	// 2003-0902 test to provoke TA > 1MB error
//	nCEDMemPts	=  8000000;	nPnts	= 1046821;	nSmpInt	=  50;	nDA	= 1;	nAD	= 1;	nTG	= 1;	nSlices	=  1630	// 2003-0902  131x131x61 test to provoke TA > 1MB error
//	nCEDMemPts	=  8000000;	nPnts	= 1081143;	nSmpInt	=  50;	nDA	= 1;	nAD	= 1;	nTG	= 1;	nSlices	=  1630	// 2003-0902  131x131x63 test to provoke TA > 1MB error
//	nCEDMemPts	=  80000000;	nPnts	= 1081143;	nSmpInt	=  50;	nDA	= 1;	nAD	= 1;	nTG	= 1;	nSlices	=  1630	// 2003-0902  131x131x63 test to provoke TA > 1MB error
//	nCEDMemPts	=  80000000;	nPnts	= 131*131*7*11;	nSmpInt	=  50;	nDA	= 1;	nAD	= 1;	nTG	= 1;	nSlices	=  1630	// 2003-0902test to provoke TA > 1MB error
//	nCEDMemPts	=  80000000;	nPnts	= 131*131*7*13;	nSmpInt	=  50;	nDA	= 1;	nAD	= 1;	nTG	= 1;	nSlices	=  1630	// 2003-0902test to provoke TA > 1MB error
//	nCEDMemPts	=  80000000;	nPnts	= 131*131*7*17;	nSmpInt	=  50;	nDA	= 1;	nAD	= 1;	nTG	= 1;	nSlices	=  1630	// 2003-0902test to provoke TA > 1MB error
//	nCEDMemPts	=  80000000;	nPnts	= 131*131*7*19;	nSmpInt	=  50;	nDA	= 1;	nAD	= 1;	nTG	= 1;	nSlices	=  1630	// 2003-0902test to provoke TA > 1MB error
//	nCEDMemPts	=  80000000;	nPnts	= 131*131*11*13;	nSmpInt	=  50;	nDA	= 1;	nAD	= 1;	nTG	= 1;	nSlices	=  1630	// 2003-0902test to provoke TA > 1MB error
//	nCEDMemPts	=  80000000;	nPnts	= 131*131*11*17;	nSmpInt	=  50;	nDA	= 1;	nAD	= 1;	nTG	= 1;	nSlices	=  1630	// 2003-0902test to provoke TA > 1MB error
//	nCEDMemPts	=  80000000;	nPnts	= 131*131*11*19;	nSmpInt	=  50;	nDA	= 1;	nAD	= 1;	nTG	= 1;	nSlices	=  1630	// 2003-0902test to provoke TA > 1MB error
//	nCEDMemPts	=  8000000;	nPnts	= 131*131*7*19*11;	nSmpInt	=  50;	nDA	= 1;	nAD	= 1;	nTG	= 1;	nSlices	=  1630	// 2003-0902test to provoke TA > 1MB error
//
//	nCEDMemPts	=  8000000;	nPnts	= 131*137*2*29;	nSmpInt	=  50;	nDA	= 1;	nAD	= 1;	nTG	= 1;	nSlices	=  1630	// 2003-0902test to provoke TA > 1MB error
//	nCEDMemPts	=  8000000;	nPnts	= 131*137*2*31;	nSmpInt	=  50;	nDA	= 1;	nAD	= 1;	nTG	= 1;	nSlices	=  1630	// 2003-0902test to provoke TA > 1MB error
//	nCEDMemPts	=  8000000;	nPnts	= 131*137*3*19;	nSmpInt	=  50;	nDA	= 1;	nAD	= 1;	nTG	= 1;	nSlices	=  1630	// 2003-0902test to provoke TA > 1MB error
//	nCEDMemPts	=  8000000;	nPnts	= 131*137*4*14;	nSmpInt	=  50;	nDA	= 1;	nAD	= 1;	nTG	= 1;	nSlices	=  1630	// 2003-0902test to provoke TA > 1MB error
//	nCEDMemPts	=  8000000;	nPnts	= 131*139*7*9;		nSmpInt	=  50;	nDA	= 1;	nAD	= 1;	nTG	= 1;	nSlices	=  1630	// 2003-0902test to provoke TA > 1MB error
//	nCEDMemPts	=  8000000;	nPnts	= 137*139*7*9;		nSmpInt	=  50;	nDA	= 1;	nAD	= 1;	nTG	= 1;	nSlices	=  1630	// 2003-0902test to provoke TA > 1MB error
//	nCEDMemPts	=  8000000;	nPnts	= 131*149*7*9;		nSmpInt	=  50;	nDA	= 1;	nAD	= 1;	nTG	= 1;	nSlices	=  1630	// 2003-0902test to provoke TA > 1MB error
//	nCEDMemPts	=  8000000;	nPnts	= 151*149*7*7;		nSmpInt	=  50;	nDA	= 1;	nAD	= 1;	nTG	= 1;	nSlices	=  1630	// 2003-0902test to provoke TA > 1MB error
//	nCEDMemPts	=  8000000;	nPnts	= 151*149*7*9;		nSmpInt	=  50;	nDA	= 1;	nAD	= 1;	nTG	= 1;	nSlices	=  1630	// 2003-0902test to provoke TA > 1MB error
//	nCEDMemPts	=  8000000;	nPnts	= 151*151*7*9;		nSmpInt	=  50;	nDA	= 1;	nAD	= 1;	nTG	= 1;	nSlices	=  1630	// 2003-0902test to provoke TA > 1MB error
//	nCEDMemPts	=  8000000;	nPnts	= 151*151*5*9;		nSmpInt	=  50;	nDA	= 1;	nAD	= 1;	nTG	= 1;	nSlices	=  1630	// 2003-0902test to provoke TA > 1MB error
...
//
//	nTrfAreaPts	= SetPoints( sFolder, wG, nCEDMemPts, nPnts, nSmpInt , nDA, nAD, nTG, nSlices, UFCom_kERR_IMPORTANT, UFCom_kERR_IMPORTANT )	//(//	UF_AcqCed	// all params are points not bytes	
//
...
//
//
//Function		SetPointsTestCont( sFolder, wG )		// 2003-0724
...
//	do
//		nCEDMemPts	= UFCom_Random(  500000, 8000000, 500000 )
//		nPnts		= UFCom_Random(  200, 10000000, 2 )			// decreasing the step size to 2..8 will issue more 'Data points' warnings and errors
//		nSmpInt		= UFCom_Random(  20, 220, 5 )
//		nDA			= UFCom_Random(  1, 3, 1 )
//		nAD			= UFCom_Random(  1, 4, 1 )
//		nTG			= UFCom_Random(  0, 3, 1 )
//		nSlices		= UFCom_Random(  10, 5000, 20 )
//
//		nTrfAreaPts	= SetPoints( sFolder, wG, nCEDMemPts, nPnts, nSmpInt , nDA, nAD, nTG, nSlices, UFCom_kERR_IMPORTANT, UFCom_kERR_IMPORTANT )	//(//UF_AcqCed	// all params are points not bytes	
//
//		SmpArEndDA	= gSmpArOfsDA + trunc( 2 * gChnkPerRep * gPntPerChnk * nDA + .5 )			// like SetPoints ()	
...
//
//
//Function		SetPointsTestContNeighbors( sFolder, wG )		// 2003-0724
//// for finding problematic combinations of nCEDMemPts, nPnts, nSmpInt, nDa, nAD, nTG, nSlices, e.g. nReps > 100,  nChunksPerRep > 100,  Chunktime < 100 ms
//	string  	sFolder
//	wave	wG
//   	variable	nCEDMemPts, nPnts, nSmpInt, nDA, nAD, nTG, nSlices, OptChkTimeMs	// input parameters
...
//	do
//		nCEDMemPts	= UFCom_Random(  500000, 8000000, 500000 )
//		nPnts		= UFCom_Random(  100, 10000000, 2 )			// decreasing the step size to 2..8 will issue more 'Data points' warnings and errors
//		nSmpInt		= UFCom_Random(  20, 220, 5 )
//		nDA			= UFCom_Random(  1, 3, 1 )
//		nAD			= UFCom_Random(  1, 4, 1 )
//		nTG			= UFCom_Random(  0, 3, 1 )
//		nSlices		= UFCom_Random(  10, 5000, 20 )
//		CheckNeighbors( sFolder, wG, nCEDMemPts, nPnts, nSmpInt , nDA, nAD, nTG, nSlices, Neighbors )	//(// UF_AcqCed
//	while ( UFCom_TRUE )
//End
// 2008-04-22 moveToAcqCed
...
// Primes
	...
	for ( n =  nStart; n < nEnd; n += 2 )
		lstFactors	= UFCom_FPPrimeFactors( sFo, n )
		printf "\t\tFPPrimeFactors( %d ) : \t%s\tIgor:\t", n,  UFCom_pd( lstFactors, 32)
		PrimeFactors	n
	endfor
	
	// Step 2 : measure time needed to compute primes
	UFCom_KillAllTimers( sFo )

	UFCom_ResetStartTimer( sFo, "IPrime" )
	for ( n =  nStart; n < nEnd; n += 2 )
		PrimeFactors /Q  n
	endfor
	UFCom_ReadTimer( sFo, "IPrime" )
	UFCom_StopTimer( sFo, "IPrime" )

	UFCom_ResetStartTimer( sFo, "FPrime" )
	for ( n =  nStart; n < nEnd; n += 2 )
		lstFactors	= UFCom_FPPrimeFactors( sFo, n )
	endfor
	UFCom_ReadTimer( sFo, "FPrime" )
	UFCom_StopTimer( sFo, "FPrime" )
	
	UFCom_PrintAllTimers( sFo, UFCom_kON )
	UFCom_KillAllTimers( sFo )
End
...
Function		fTest11( s )
	struct	WMButtonAction &s
	printf "\tReplaceListItem   %s\r", s.ctrlName
	string  	sList, sItem
	...
	for ( nPos = 0; nPos < nMax; nPos += 1 )
	 	UFCom_ReplaceListItem1( sItem, sList, sListSep, nPos )
	endfor 
	sList		= "0,1,2"
	for ( nPos = 0; nPos < nMax; nPos += 1 )
	 	UFCom_ReplaceListItem1( sItem, sList, sListSep, nPos )
...
// 2003-0911 empirical ly found: 1. the minimum and the maximum requested working size (accessible only in XOP) must be  at least 36 KB more than the needed Transfer area points (*2) 
...
// 2003-0912 obsolete and useless when minimum and the maximum requested working size are fixed and independent of TransferAreaPoints  as it is now....
	variable	nResult	= 0
...
string   	sFo = "keep1"
	...
	do 
		n	+= 1
		nTrfAreaPts	= UFCom_Random(  100, 524288, 2 )	
...
static Function		TestHeapScramble( sFolder, sFo, n, nTrfAreaPts )
	// 2004-1203  TEST to detect heap scramble problems : This code is equivalent to the main 'Apply Script' code up to  Nov04 which failed sporadically due to a heap scramble bug.
	string  	sFolder, sFo
	...
	variable	nHeapPts	= UFCom_Random(  100, 100000, 2 )	
	...
	variable	nRedimPts	= UFCom_Random(  100, 100000, 2 )	
...
//
//	wave  /Z	wRaw	= $"root:uf:" + sFolder + ":" + sFo + ":wRaw"  	// 2004-1203 must be PERMANENT data folder, will give sporadic heap scramble problems if a regularly cleared folder (e.g.ar) is used	
//	if ( waveExists( wRaw ) )
//		nvar	/Z gResult	= $"root:uf:" + sFolder + ":gResult"
//		if ( nvar_exists( gResult )  && gResult == 0 ) 
//			nResultUnset	= UFP_CedUnsetTransferArea( 0, wRaw, showMode ) 
//			if ( nResultUnset )   
...
//		endif														
//	endif
//	KillDataFoldUnconditionly( "root:uf:" + sFolder + ":" + sFo + ":"	 ) 		// does   work
//	NewDataFolder  /O $"root:uf:" + sFolder + ":" + sFo					// this is OK and required only when 'sFo'  is not 'keep'  e.g. when it is 'keep1' 
...
//  Todo : adopt this code to the real acquisition and check if  the redimensioning-error is gone even when  'bCRASH_ON_REDIM_TEST14'  is ON (running Test14 /butest14)
	wave  /Z	wRaw	= $"root:uf:" + sFolder + ":" + sFo + ":wRaw"  			// 2005-1108 works with a regularly cleared folder (e.g. 'keep1') 	
	if ( waveExists( wRaw ) )
		nvar	/Z gResult	= $"root:uf:" + sFolder + ":gResult"
		if ( nvar_exists( gResult )  && gResult == 0 ) 
			nResultUnset	= UFP_CedUnsetTransferArea( hnd, 0, wRaw, showMode ) 	// The attempt to unset a non-existing transfer area  (=error -528)  will do no harm as it is caught in the XOP.
	...
	UFCom_KillDataFoldUnconditionly( "root:uf:" + sFolder + ":" + sFo )				// does   work
...
//	NewDataFolder  	 $"root:uf:" + sFolder + ":" + sFo						// this is OK and required only when 'sFo'  is not 'keep'  e.g. when it is 'keep1' 
	...
	gResult			= UFP_CedSetTransferArea( hnd, 0, nTrfAreaPts, wRaw , showMode )
	if ( gResult )   
...
Function		fTest13( s )
	...
	code		= UFP_CedLdErrOut( hnd, UFPE_MSGLINE, sCmdDir, sCmds )
...
static Function		HeapScramble()
	//string  	sDir		= "C:UserIgor:Ced:Scripts:DemoScripts:"
	//string  	sDir		= "C:UserIgor:FPulse_:Scripts:ErrorScripts:"
	string  	sDir		= "D:UserIgor:FPuls_:Scripts:ErrorScripts:"
	string 	lstScripts	= UFCom_ListOfMatchingFiles( sDir, "*.txt", UFCom_FALSE )
	//string 	lstScripts	= "AP2.txt;AP136.txt;DemoTG100us.txt;"
	...
	string  	sTxt	= "Heap scramble + AutoLoadScripts\r\rCan only be stopped with  'Abort' "
	DoAlert 0, sTxt
	printf "\r%s\rWill continuously load %d scripts from '%s'  '%s' \r", sTxt, ItemsInList(lstScripts), sDir, lstScripts[ 0, 200 ]
	
	string  	sScriptPath, sScript
	variable	n, nScripts	= ItemsInList( lstScripts )
	variable	Code, cnt	= 0
	do
		for ( n = 0; n < nScripts; n += 1 )
			printf "\t%3d/%3d \t", n, nScripts
			sScript		= sDir + StringFromList( n, lstScripts ) 

			ScriptPathSet( ksACQ, ksFPUL, sScript )							// set global early enough : before  LoadProcessScript   so that script name is known within  LoadProcessScript   in case of an error...
			sScriptPath	= LoadScriptFileDialog( sScript, UFPE_ksSCRIPTS_SYMPATH )
			Code			= LoadProcessScript( ksACQ , sScriptPath )					
			cnt += 1
		//GN	UFCom_Delay( .5 )		// sacrifice some time to allow Igor to react on changed controls.  Without this it is not possible to change e.g. any debug print options.
		endfor
	while ( Code == UFCom_kOK  &&  cnt > 0  )			// Stop at first error or if there are no scripts.   User may exit prematurely with  'Abort'  
End
...
Function		fTest15( s )
	...
	variable	nBlankPixels, nBlanks, nPixel1Blank	= FontSizeStringWidth( UFCom_ksFONT, UFCom_kFONTSIZE, 0, " " ) 
...
static Function	TestSetvarAndPopupmenu( sTxt, xs, bodyw, xp, dy, n )
	string  	sTxt
 	variable	xs, bodyw, xp, dy, n
	UFCom_FormatSetvarPopup( sTxt, xs, bodyw )		// references are changed
...
Function		fTest16( s )
	struct	WMButtonAction &s
	printf "\r\tTest16   Try-Catch-EndTry: Execute from the command line   foo_(0)  ..  foo_(6)   \r" 
End

//	try-catch-endtry Example
// The following example demonstrates how abort flow control may be used. 
// Execute the foo function with 0 to 6 as input parameters.  foo_(0) ... foo_(6)
Function foo_(a)
	Variable a
...
//	DefaultGuiFont/Win Button		={"Arial",11,0} 		// OK : affects Button
//	DefaultGuiFont/Win Checkbox	={"Arial",11,0} 		// OK : affects Checkbox
//	DefaultGuiFont/Win Panel		={"Arial",8,0} 		// OK : affects Setvariable text
...
Function		fTest18( s )
	struct	WMButtonAction &s
	printf "\tTest18  ksFONT and UFCom_kFONTSIZE \r"
...
Function		fTest21( s )
	...
	printf "\r\tTest21 does not work as Igor's   'FontSizeStringWidth()'   does not return correct values ->  UFCom_pd()  and pad()  cannot work either... \r"
...
static Function  /S  pdT( str, len, fct )
...
// 161002 automatically encloses str  ->  'str'
	...
	if ( nDiffPixel >= 0 )			// string is too short and must be padded
		// printf  " UFCom_pd( '%s' , %2d ) has pixel:%d \trequested pixel:%2d \tnDiffPixel:%d  padding spaces to len :%d ->'%s' \r", str, len, nStringPixel, nRequestedPixel,nDiffPixel, oldLen+nDiffPixel / cSPACEPIXEL, PadString( str, oldlen + nDiffPixel / cSPACEPIXEL,  0x20 ) 	
		str	+= "'"
		do
			str	+= " "
	...
	if ( nDiffPixel < 0 )			// string is too long and must be truncated
		// printf  " UFCom_pd( '%s' , %2d ) has pixel:%d \trequested pixel:%2d \tnDiffPixel:%d  truncating chars:%d  ->'%s' \r", str, len, nStringPixel, nRequestedPixel,nDiffPixel,   ceil( nDiffPixel / cTYPICALCHARPIXEL ),str[ 0,OldLen - 1 + ceil( nDiffPixel / cTYPICALCHARPIXEL ) ] 
		do
			OldLen	= strlen( str )
			str		= str[ 0, OldLen - 2 ]
...
Function		fTest22( s )
	struct	WMButtonAction &s
	printf "\r\tTest22  Subrange display\r"

	make /O /N=50 wA=p
	make /O /N=100 wB=p
	SetScale /I x, 100, 200, wB

	UFCom_PossiblyKillGraph( "test" )
	display /K=1 /N=$"test"

	string sAxNmA= "axA", sAxNmB= "axB"
	AppendToGraph /W=test /B=$sAxNmA  wA
	AppendToGraph /W=test /B=$sAxNmB  wB

	ModifyGraph	/W=test 	axisEnab(  $sAxNmA )	= {  0, .30 }			
	ModifyGraph	/W=test 	axisEnab(  $sAxNmB )	= {  .35, 1.00 }			

	ModifyGraph	/W=test	freePos( $sAxNmA ) = { 0, left }
	ModifyGraph	/W=test	freePos( $sAxNmB ) = {  0, left }
...
Function		fTest23( s )
	struct	WMButtonAction &s
	printf "\tMemory     \t\t   \t\tAvailPhys:    \t %9.3lf MB\tAvailVirtual:  \t %9.3lf MB\r", UFCom_UtilAvailPhys() / UFCom_MEGABYTE, UFCom_UtilAvailVirtual() / UFCom_MEGABYTE
End
...
//	printf "\t\t%s\thas value%2d  \r",  UFCom_pd( s.ctrlName,24 ), s.nVal
//End
//
...
Function		bu_DICOLTXT_Test_( ctrlName ) : ButtonControl
...
Window MeterPanel4() : Panel
	PauseUpdate; Silent 1		// building window...
	NewPanel /W=(648,55,957,305) /K=1
	SetDrawLayer UserBack
	DrawText 87,38,"Mouse Moved Speed"
	CustomControl cc30,pos={45,53},size={223,180},proc=MyCC_MeterFunc4
...
Structure CC_MeterInfo4
	double voltage		// voltage value (0-10)
	STRUCT Point lastMouse
EndStructure


Function MyCC_MeterFunc4(s)
	STRUCT WMCustomControlAction &s

	STRUCT CC_MeterInfo4 info
	
	if( s.eventCode==UFCom_CCE_drawOSBM )
		drawscale1(0,10,10)
	elseif( s.eventCode==UFCom_CCE_draw )
...
//		drawneedle1( s.nVal )				//   needed only for Version2 : needle ~ COLTXT-button
	...
	elseif( s.eventCode==UFCom_CCE_mousemoved )
		StructGet/S info,s.userdata
...
// Test1 :  LH added ....
//        elseif( s.eventCode==UFCom_CCE_modernize )
//                StructGet/S info,s.userdata
//                info.voltage= s.nVal
//                StructPut/S info,s.userdata     // will be written out to control
...
static Function drawscale1(vmin,vmax,n)
...
Window 	NumberPanel4() : Panel
	...
	CustomControl ccClickTheNumber,pos={182,37},size={28,49},proc=MyCC_CounterFunc4
	CustomControl ccClickTheNumber,userdata= A"!!!!$",picture= {ProcGlobal#Numbers0to9_1,10}

	//  the Color field 1
	CustomControl ccColorField,pos={160,100}, proc=MyCC_ColorFieldFunc_
	...
	//  the Color field 2
	CustomControl ccColorField2,pos={160,130}, proc=MyCC_ColorFieldFunc_2
...
Function 	MyCC_CounterFunc4(s)
	STRUCT WMCustomControlAction &s

	STRUCT CC_CounterInfo1 info

	if (  s.eventCode != UFCom_CCE_idle  &&  s.eventCode != UFCom_CCE_mousemoved ) 
	//if (  s.eventCode != UFCom_CCE_mousemoved ) 
		printf "\tMyCC_CounterFunc4() \tnVal:%d \tEventCode:%2d    \t%s \r ", s.nVal,  s.eventCode,  UFCom_pd( StringFromList( s.eventCode, UFCom_CCE_lstEVENTCODES ), 8 )
	endif	

	if( s.eventCode==UFCom_CCE_frame )
		StructGet/S info,s.userdata
		s.curFrame= mod(info.theCount+(s.curFrame!=0),10)
	elseif( s.eventCode==UFCom_CCE_mouseup )
		StructGet/S info,s.userdata
...
Function 	MyCC_ColorFieldFunc_( s )
	STRUCT WMCustomControlAction &s

	if (  s.eventCode != UFCom_CCE_idle  &&  s.eventCode != UFCom_CCE_mousemoved ) 
		// printf "\tMyCC_ColorFieldFunc() \tnVal:%d \tEventCode:%2d    \t%s \r ", s.nVal,  s.eventCode,  UFCom_pd( StringFromList( s.eventCode, UFCom_CCE_lstEVENTCODES ), 8 )
	endif	
	if( s.eventCode==UFCom_CCE_frame )	// could / should use UFCom_CCE_draw ?
		s.curFrame= s.nVal
	endif
	return 0
End
...
Function 	MyCC_ColorFieldFunc2_( s )
	STRUCT WMCustomControlAction &s

	if (  s.eventCode != UFCom_CCE_idle  &&  s.eventCode != UFCom_CCE_mousemoved ) 
		// printf "\tMyCC_ColorFieldFunc2()\tnVal:%d \tEventCode:%2d    \t%s \r ", s.nVal,  s.eventCode,  UFCom_pd( StringFromList( s.eventCode, UFCom_CCE_lstEVENTCODES ), 8 )
	endif	
	if( s.eventCode==UFCom_CCE_frame )	// could / should use UFCom_CCE_draw ?
		s.curFrame= s.nVal
	endif
