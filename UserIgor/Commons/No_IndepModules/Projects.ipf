...
//
//		Can append    prefixes  to functions and constants so that they are unique to the project  e.g.  'pad()' 		-> 'UFCom_pad()'  , 	'UFCom_kNOTFOUND' 			-> 'UFCom_UFCom_kNOTFOUND'
//		Can exchange prefixes of functions and constants so that they are unique to the project  e.g.  'UFCom_pad()' 	-> 'UFSec_pad()'  , 	'UFCom_UFCom_kNOTFOUND' 	-> 'UFFPu_UFCom_kNOTFOUND'
...
// Version2b : 	Rename 4 other constants
	string  	sText		= "UFCom_kIGOR_;UFCom_UFCom_kIGOR_;"  ;								Prompt 	sText, 		"Converting1: "
	string  	sText1		= "UFCom_kSORT;UFCom_UFCom_kSORT;" ;								Prompt 	sText1, 		"Converting2: "
	string  	sText2		= "UFCom_kNOTFOUND;UFCom_UFCom_kNOTFOUND;"  ;					Prompt 	sText2, 		"Converting3: "
	string  	sText3		= "UFCom_kNUMTYPE_NAN;UFCom_UFCom_kNUMTYPE_NAN;"  ;				Prompt 	sText3, 		"Converting4: "
	string  	lstTexts		= sText + sText1+ sText2+ sText3		// Cave, cave, cave:   The semicolons are vital.  One more or less will ruin all the files! 
	DoPrompt "Will disable...", sText , sText1, sText2, sText3,  lstSrcDirs , sSubDir
